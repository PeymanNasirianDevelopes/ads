...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset("pdf/4th/favicon-.png")}}">
    ...
    <link href="{{asset("pdf/4th/Fonts000.css")}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset("pdf/4th/all00000.css")}}" />

    <link href="{{asset("pdf/4th/DefaultR.css")}}" rel="stylesheet">

    <script src="{{asset("pdf/4th/jquery00.js")}}"></script>
    <script src="{{asset("pdf/4th/less0000.js")}}"></script>
    <link href="{{asset("css/01font-a.css")}}" rel="stylesheet">


    <link href="{{asset("pdf/4th/Template.css")}}" rel="stylesheet" />
...
</style>    <link href="{{asset("pdf/4th/credit-h.css")}}" rel="stylesheet" />
<header>
    ...
    <div class="container">
        <div class="row" style="height:100%">
            <div class="smbox col-narrow sortable-cv-items">
                ...
                <h1 class="not-drag" style="text-transform: uppercase">{{$resume->name}} {{$resume->last_name}}</h1>
    ...
    <div class="property-item language__list" data-section="Language">
        ...
        <div class="property-item_body">
            ...
            <div style="direction: ltr !important;" class="lgbox col-wide sortable-cv-items">
                        ...
                        @foreach($skills_exp as $xp)
                            ...
                            <li>
                                <div class="c100 p100 small">
                                    <span>{{$xp->ex_state *20}}%</span>
                                    <div class="slice">
                                        <div class="bar"></div>
                                        <div class="fill"></div>
                                    </div>
                                    <div class="circle-progress__title">{{$xp->ex_name}}</div>
                                </div>
                            </li>
                            @endif
                        @endforeach
...
<link href="{{asset("pdf/4th/gmodal00.css")}}" rel="stylesheet" />
<style>
    ul.gModal-features {
        width: 75%;
        margin-right: auto;
...
<script src="{{asset("pdf/4th/gmodal00.js")}}" type="text/javascript"></script>
...
<script src="{{asset("pdf/4th/template.js")}}"></script>
<script>
...
<script async src="{{asset("pdf/4th/js000000.js")}}"></script>
<script>
